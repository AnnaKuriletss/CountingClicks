...
def shorten_link(access_token, url_to_shorten):
    ...
    params = {"url": url_to_shorten, "access_token": access_token, "v": "5.131"}
...
def is_short_link(access_token, url):
    ...
    params = {"key": parsed_url.path[1:], "access_token": access_token, "v": "5.131"}
...
def main():
    parser = argparse.ArgumentParser(
        description="Сокращение ссылок и получение статистики кликов."
    )
